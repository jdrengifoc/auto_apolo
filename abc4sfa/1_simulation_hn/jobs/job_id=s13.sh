...
#SBATCH --output=negacion_empirica/apolo_info/job_id=s13.out
#SBATCH --error=negacion_empirica/apolo_info/job_id=s13.err
...
echo "Wed Mar 19 18:59:16 -05 2025: Ejecutando Rscript negacion_empirica/jobs/main_id=s13.R"
Rscript negacion_empirica/jobs/main_id=s13.R
